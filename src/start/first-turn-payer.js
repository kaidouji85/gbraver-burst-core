...
import type {PlayerGameState} from '../game-state/player-game-state';
 ...
 * @return 先行プレイヤーのID
 */
export function getFirstTurnPlayer(player1: PlayerGameState, player2: PlayerGameState): PlayerId {
