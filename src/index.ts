...
export { correctedBattery, totalBatteryCorrection } from "./effect/battery-correction";
...
export type { GameEnd, GameEndResult, GameEndX } from "./effect/game-end/game-end";
export type { Effect } from "./effect/index";
export type { InputCommand, NoChoice, Selectable } from "./effect/input-command/input-command";
...
export type { EndArmdozerEffect, UpdateRemainingTurn } from "./effect/update-remaning-turn/update-remaining-turn";
export { EMPTY_ARMDOZER_EFFECT, EMPTY_CORRECT_POWER } from "./empty/amrdozer-effect";
export { EMPTY_ARMDOZER, EMPTY_ARMDOZER_STATE, EMPTY_BURST } from "./empty/armdozer";
...
export { restoreGbraverBurst, startGbraverBurst } from "./game/gbraver-burst-core";
...
export type { BatteryLimitBreak, BuffPower, Burst, ContinuousAttack, LightningBarrier, RecoverBattery } from "./player/burst";
export type { BatteryEnchantmentSkill, BuffPowerSkill, DamageHalvedSkill, Pilot, PilotId, PilotSkill, PilotX, RecoverBatterySkill } from "./player/pilot";
export type { Player, PlayerId, PlayerX } from "./player/player";
export type { ArmdozerEffect, BatteryCorrection, ContinuousActivePlayer, CorrectPower, DamageHalved, EmptyArmdozerEffect, TryReflect } from "./state/armdozer-effect";
