import {parseReflectDamageEffect, ReflectDamageEffect} from "../../src/state/armdozer-effect";

/** 有効なReflectDamageEffect */
const reflectDamageEffect: ReflectDamageEffect = "Lightning";

test("ReflectDamageEffectSchemaでパースできる", () => {
  expect(parseReflectDamageEffect(reflectDamageEffect)).toEqual(reflectDamageEffect);
});
