...
const player1Command = {playerId: player1.playerId, command};
const player2Command = {playerId: player2.playerId, command};

test('全プレイヤーがコマンド入力したことを正しく検知できる', t => {
...
test('1人のプレイヤーしかコマンド入力していない場合、全プレイヤー入力でないと判定する', t => {
  const players = [player1, player2];
